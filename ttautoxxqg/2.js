...
var url = 'https://cdn.sec-an.cn/d/storage01/Better-Auto-XXQG/Study/QuestionBank.db?sign=5e6ea3162243838e';
...
var init_url = 'https://cdn.sec-an.cn/d/storage01/Better-Auto-XXQG/Study/question?sign=22ee6e15716802cb';
var file_tmp = false;
var tikus = '';
/**
 * 获取用户token
...
function show_log() {
    threads.start(function () {
        try {
            var text = http.get('https://cdn.sec-an.cn/d/storage01/Better-Auto-XXQG/Study/showlogs?sign=0e8363d0ee92dbab').body.string();
            if (text.length == 0) {
                show_log = true;
                return;
            }
...
function init() {
    ...
    threads.start(function () {
        try {
            var x = http.get('https://cdn.sec-an.cn/d/storage01/Better-Auto-XXQG/Study/replace.js?sign=537bbdb4cd5d1141').body.string();
