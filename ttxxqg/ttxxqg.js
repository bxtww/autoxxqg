var hamibot={env:{wenzhang:"true",meizhou:"zhengxu",zhuanxiang:"zhengxu",dingyue:"zhengxu",shipin:"true",meiri:"true",siren:"true",bendi:"true",shuangren:"true",dacuo_num:"0",yinliang:"0",tiaozhan:"true",duizhan_mode:"suiji",guaji:true,is_exit:true,ddtong:false,jisu:"",ocr_maxtime:"5000",slide_verify:"1000",pinglun:"true",yl_on:true,zhanghao:"",APP_ENV:"production",USER_ID:"",ROBOT_ID:"",SCRIPT_ID:"",TIMESTAMP:""},plan:{name:"免费",onFreeTrial:false,model:"free"},robotName:"",};
...
//   if (checked) {storage.put(engine_version, false);}
  let gengxin_rows = ["强国APP版本v2.33.0以上不支持订阅",
                      "联系方式：微信：xuexilaisiji；tg: t.me/wyqg_ttxs"];
