...
var hamibot={env:{wenzhang:"true",meizhou:"zhengxu",zhuanxiang:"zhengxu",dingyue:"zhengxu",shipin:"true",meiri:"true",
                  siren:"true",bendi:"true",shuangren:"true",dacuo_num:"0",yinliang:"0",tiaozhan:"true",duizhan_mode:"suiji",
                  guaji:false,is_exit:false,ddtong:false,jisu:"",ocr_maxtime:"1000",slide_verify:"1000",pinglun:"true",yl_on:true,
                  zhanghao:"",APP_ENV:"production",USER_ID:"",ROBOT_ID:"",SCRIPT_ID:"",TIMESTAMP:""},plan:{name:"免费",onFreeTrial:false,model:"free"},robotName:"",};
...
// 脚本版本号
var last_version = "V100.9";
var engine_version = "V100.10";
var newest_version = "V100.11";
...
//   if (checked) {storage.put(engine_version, false);}
  let gengxin_rows = ["老司机专用，不得外传",
                      "1.本人没有义务免费解决问题",
                      "2.此版本没特殊情况不更新，题库运行自动更新",
                      "3.QQ：807397510，微信：xuexilaosiji，不做义务劳动",
                      "4.拒绝白嫖，天下没有免费的午餐"];
...
// console.show();
fInfo("学习老司机Pro"+newest_version+"脚本初始化");
...
function fInit() {
  ...
  var w = floaty.rawWindow(
    <card cardCornerRadius='8dp' alpha="0.8">
      <vertical>
        ...
        <text id='version' textColor="#FFFFFF" textSize="18dip">学习老司机+</text>
  ...
  ui.run(function() {
    ...
    w.version.setText("学习老司机+"+newest_version);
  });
  w.setSize(720, -2);
  w.setPosition(10, 10);
...
if (zhanghao) {
  ...
  if (zhanghao_list.length > 2) {zhanghao_list.length = 2;}
